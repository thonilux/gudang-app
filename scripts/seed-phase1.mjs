...
async function main() {
  ...
  try {
    ...
    const equipmentSeed = [
      ...
      {
        code: "EQ-AUD-001",
        name: "Console Mixer Digital Midas M32",
        categoryKey: "audio",
        locationCode: "WH-UTAMA-A",
        brand: "Midas",
        model: "M32",
        serialNumber: "EQ-AUD-001",
        status: "ready",
        conditionNote: "Siap dipakai.",
        specificationNote: "Digital console mixer.",
        notes: "Mixer utama.",
      },
      {
        code: "EQ-VID-001",
        name: "Kamera Sony PXW-FX9",
        categoryKey: "video",
        locationCode: "SR-01",
        brand: "Sony",
        model: "PXW-FX9",
        serialNumber: "EQ-VID-001",
        status: "inspection_due",
        conditionNote: "Perlu pengecekan lensa.",
        specificationNote: "Cinema line camera.",
        notes: "Kamera video utama.",
      },
      {
        code: "EQ-LGT-001",
        name: "Moving Head LED 350W",
        categoryKey: "lighting",
        locationCode: "WH-UTAMA",
        brand: "Generic",
        model: "LED 350W",
        serialNumber: "EQ-LGT-001",
        status: "maintenance",
        conditionNote: "Mati total.",
        specificationNote: "Moving head fixture.",
        notes: "Perlu cek board regulator.",
      },
    ];
